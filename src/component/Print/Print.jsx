    ...
    <div className={cx("wrapper")}>
      ...
      <div className={cx("container")}>
        ...
        <div className={cx("select")}>
          ...
          <Radio.Group
            onChange={onChangeCountPage}
            value={countpage}
            className={cx("select-pages")}
          >
            <Radio value={1} className={cx("radio-check")}>
              Tất cả
            </Radio>
            <Radio value={2} className={cx("radio-check")}>
              Chỉ trang chẳn
            </Radio>
            <Radio value={3} className={cx("radio-check")}>
              Chỉ trang lẻ
            </Radio>
            <Radio value={4} className={cx("radio-check")}>
              {" "}
              Tùy chỉnh
            </Radio>
            <Input
        ...
        <Button type="primary" className={cx("accept")}>
          Xác nhận in
        </Button>
      </div>
    </div>
