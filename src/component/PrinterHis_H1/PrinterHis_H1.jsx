...
import styles from "./PrinterHis_H1.module.scss";
...
function PrinterHis_H1() {
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <h2 className={cx("title")}>LỊCH SỬ IN ẤN THEO TỪNG MÁY IN Ở H1</h2>
