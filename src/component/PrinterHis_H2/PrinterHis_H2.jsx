...
import styles from "./PrinterHis_H2.module.scss";
...
function PrinterHis_H2() {
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <h2 className={cx("title")}>LỊCH SỬ IN ẤN THEO TỪNG MÁY IN Ở H2</h2>
