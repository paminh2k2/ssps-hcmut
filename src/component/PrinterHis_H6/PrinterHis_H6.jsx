...
import styles from "./PrinterHis_H6.module.scss";
...
function PrinterHis_H6() {
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <h2 className={cx("title")}>LỊCH SỬ IN ẤN THEO TỪNG MÁY IN Ở H6</h2>
