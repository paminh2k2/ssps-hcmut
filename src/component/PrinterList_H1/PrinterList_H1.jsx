...
import styles from "./PrinterList_H1.module.scss";
...
function PrinterList_H1() {
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <h1 className={cx("title")}>{`DANH SÁCH MÁY IN Ở H1`}</h1>
