...
import styles from "./PrinterList_H2.module.scss";
...
function PrinterList_H2() {
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <h1 className={cx("title")}>{`DANH SÁCH MÁY IN Ở H2`}</h1>
