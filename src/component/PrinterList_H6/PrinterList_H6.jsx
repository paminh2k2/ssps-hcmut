...
import styles from "./PrinterList_H6.module.scss";
...
function PrinterList_H6() {
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <h1 className={cx("title")}>{`DANH SÁCH MÁY IN Ở H6`}</h1>
